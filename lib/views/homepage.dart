...
class _HomepageState extends State<Homepage> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // App Description
          Text(
            'Here We Go is a location sharing application. First establish connection with server and share your location then show it on map.',
            style: TextStyle(
              fontSize: 16,
  ...
  // Connection Section (existing _buildConnectionSection)
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton.icon(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: _isConnected ? Colors.red.shade600 : Colors.blue,
              foregroundColor: Colors.white,
          ...
          Expanded(
            child: PageView(
              ...
              children: [
                ...
                // Actions Section (only accessible when connected)
